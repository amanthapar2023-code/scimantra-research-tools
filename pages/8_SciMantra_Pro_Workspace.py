...
if section == "Project Dashboard":
    ...
    if uploaded:
        ...
        st.info("Upload a dataset to generate an automatic descriptive summary. Data remains session-scoped.")
    ...
    roadmap = pd.DataFrame([
        ...
        ["Secure accounts", "Planned", "Requires authentication/database provider"],
        ["Subscriptions", "Planned", "Requires payment provider such as Stripe"],
        ["AI research assistant", "Planned", "Requires configured AI API key"],
        ["Similarity checker", "Planned", "Requires licensed reference corpus/provider and validation"],
