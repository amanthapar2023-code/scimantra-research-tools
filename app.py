...
for label,key in [("SciMantra Pro Workspace","nav_pro_workspace"),("AI Research Assistant","nav_ai"),("Statistical Copilot","nav_copilot"),("Publication Figure Generator","nav_figures"),("Automated Research Report","nav_report"),("Experimental Design Power Analysis","nav_power"),("🧪 H₂S Publication Dashboard","nav_h2s_publication"),("🔎 Research Data Quality Audit","nav_quality_audit"),("🧪 H₂S Study Design & Sample Size","nav_study_design"),("🧬 Replicate-Aware Statistical Validation","nav_replicate_validation"),("🔎 Research Data Quality Audit","nav_quality"),
        ...
        ("🔍 Research Audit & Provenance Explorer","nav_audit_provenance"),
        ("🕒 Research Activity & Version History","nav_version_history"),
        ("🤝 Research Collaboration & Review Center","nav_collaboration_review"),("⚙️ Automated Research Pipeline","nav_pipeline"),("🗄️ Research Artifact Vault","nav_artifacts"),("🧭 Research Evidence Timeline","nav_timeline"),]: nav(label,key)
...
elif section=="🧭 Research Evidence Timeline":
    import runpy; runpy.run_path("pages/35_Research_Evidence_Timeline.py"); st.stop()

elif section=="🗄️ Research Artifact Vault":
    import runpy; runpy.run_path("pages/34_Research_Artifact_Vault.py"); st.stop()
